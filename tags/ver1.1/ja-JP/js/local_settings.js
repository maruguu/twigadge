...
var pages = new Array();
pages[0] = '<p>ユーザ名:<br><input type="text" id="user" value="" class="input-box" /></p><p>パスワード:<br><input type="password" id="pass" value="" class="input-box" /></p><p>更新間隔(分):<br><input type="text" id="interval" value="" class="input-box" /></p><p>DMの更新間隔(分):<br><input type="text" id="intervalDM" value="" class="input-box" /></p><table cellpadding="0" cellspacing="0"><tr><td style="padding:5px 5px 5px 5px;"><input type="checkbox" name="reply" value="" />起動時に返信を取得</td></tr><tr><td style="padding:5px 5px 5px 5px;"><input type="checkbox" name="post" value="" />投稿にPOSTを使う</td></tr></table>';
