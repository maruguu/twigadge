...
var pages = new Array();
pages[0] = '<p>User name:<br><input type="text" id="user" value="" class="input-box" /></p><p>Password:<br><input type="password" id="pass" value="" class="input-box" /></p><p>Refresh interval(min):<br><input type="text" id="interval" value="" class="input-box" /></p><p>Refresh interval for DM(min):<br><input type="text" id="intervalDM" value="" class="input-box" /></p><table cellpadding="0" cellspacing="0"><tr><td style="padding:5px 5px 5px 5px;"><input type="checkbox" name="reply" value="" />Get reply on booting</td></tr></table>';
