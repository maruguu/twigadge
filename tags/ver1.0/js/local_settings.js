...
var pages = new Array();
pages[0] = '<p>User name:<br><input type="text" id="user" value="" class="input-box" /></p><p>Password:<br><input type="password" id="pass" value="" class="input-box" /></p><p>Refresh interval(min):<br><input type="text" id="interval" value="" class="input-box" /></p><!--<p>Refresh interval for DM(min):<br><input type="text" id="intervalDM" value="" class="input-box" /></p>--><table cellpadding="0" cellspacing="0"><tr><td style="padding:5px 5px 5px 5px;"><input type="checkbox" name="reply" value="" />Get reply on booting</td></tr><tr><td style="padding:5px 5px 5px 5px;"><input type="checkbox" name="post" value="" />Use "POST" to refresh timeline</td></tr></table>';

pages[1] = '<table cellpadding="0" cellspacing="0"><tr><td Colspan="2">Size</td></tr><tr><td width="35px">Width:</td><td><input type="text" id="width" value="" width="160px" /></td></tr><tr><td width="35px">Height:</td><td><input type="text" id="height" value="" width="160px" /></td></tr><tr><td Colspan="2" style="width:30%" style="padding:0px 5px 0px 5px;"><input type="checkbox" name="scroller" value="" />Rewind to top on reload</td></tr><tr><td Colspan="2" style="width:30%" style="padding:0px 5px 0px 5px;"><input type="checkbox" name="fixed" value="" />Use fixed-style box</td></tr><tr><td Colspan="2" style="width:30%" style="padding:0px 5px 0px 5px;"><input type="checkbox" name="heart" value="" />Convert "<3" to heart</td></tr></table>';
