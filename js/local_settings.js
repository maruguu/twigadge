...
pages[1] = '<table cellpadding="0" cellspacing="0"><tr><td Colspan="2">ウィンドウサイズ</td></tr><tr><td width="35px">幅:</td><td><input type="text" id="width" value="" width="160px" /></td></tr><tr><td width="35px">高さ:</td><td><input type="text" id="height" value="" width="160px" /></td></tr><tr><td Colspan="2"><input type="checkbox" name="scroller" value="" />リロード時に先頭に戻る</td></tr></table>';
//pages[2] = '仮置き2';
